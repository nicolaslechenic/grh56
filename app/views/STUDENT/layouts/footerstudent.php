            ...
            <div id="footer_main">
                <div id="footer_line1">
                    ...
                    <div class="social_net">
                        <p>SUIVEZ-NOUS SUR:</p>
                        <div id="social_net">
                            <a href="www.twitter.com" class="icon"><img src="/grh56/app/public/images/icon-1.jpg"
                                    alt="Twitter icon"></a>
                            <a href="www.facebook.com" class="icon"><img src="/grh56/app/public/images/icon-2.jpg"
                                    alt="Facebook icon"></a>
                            <a href="www.linkedin.com" class="icon"><img src="/grh56/app/public/images/icon-3.jpg"
                                    alt="Linkedin icon"></a>
                        </div>
                    </div>
                </div>
                <div id="footer_line2">
                    ...
                    <a href="www.google.com">COOKIE & PRIVACY POLICY</a>
                </div>
            </div>
        </footer>
        <!-- LINKS TO SCRIPTS -->
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
        <script src="/grh56/app/public/js/active.js"></script>
        <script src="/grh56/app/public/js/hamburgerBtn.js"></script>
        <script src="/grh56/app/public/js/modalBox.js"></script>
        <script src="/grh56/app/public/js/login.js"></script>
